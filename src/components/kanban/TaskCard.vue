<template>
  <div class="box-shadow lista-div" style="cursor: pointer">
    ...
    <BadgeKanban v-if="task.type" :color="badgeColor" /><span class="ml-2 mr-2">{{ task.type }}</span>
      </div>
    </div>
...
<script>
import BadgeKanban from "./BadgeKanban.vue";
import DetalhesKanban from "./ListCard.vue";
export default {
  components: {
    BadgeKanban,
    DetalhesKanban,
